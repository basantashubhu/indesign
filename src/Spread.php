...
class Spread
{
    ...
    public static function make($pageCount = 1)
    {
        $id = uniqid();
        ...
        $spread->document->loadXML(ArrayToXml::convert([
            ...
            'Spread' => [
                ...
                'Page' => array_map(function ($page) use($id){
                    return [
                        '@attributes' => [
                            'Self' => "p$id",
                            'TabOrder' => '',
                ...
                'TextFrame' => array_map(function ($page) {
                    $itemTransform = $page == 1 ? '1 0 0 1 339.7158157884935 -17.63999999999919' : '1 0 0 1 '.(339.7158157884935+751.5).' -17.63999999999919';
                    return [
                        '@attributes' => [
